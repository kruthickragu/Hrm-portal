...
import menuIcon from "../assets/icons/menu.svg"; // Added hamburger menu icon
          ...
          <div className="nav-section">
            <div className="nav-items">
              <NavLink to="/dashboard" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={dashboardico} alt="Dashboard" className="nav-icon" />
                <span className="nav-text">Dashboard</span>
              </NavLink>

              <NavLink to="/employee" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={empico} alt="Employee" className="nav-icon" />
                <span className="nav-text">Employee</span>
              </NavLink>

              <NavLink to="/attendance" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={attenico} alt="Attendance" className="nav-icon" />
                <span className="nav-text">Attendance</span>
              </NavLink>

              <NavLink to="/payroll" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={pay} alt="Payroll" className="nav-icon" />
                <span className="nav-text">Payroll</span>
              </NavLink>

              <NavLink to="/task" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={taski} alt="Task" className="nav-icon" />
                <span className="nav-text">Task</span>
              </NavLink>

              <NavLink to="/announcement" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={annico} alt="Announcement" className="nav-icon" />
          ...
          <div className="other-section">
            ...
            <div className="nav-items">
              <NavLink to="/support" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={sup} alt="Support" className="nav-icon" />
                <span className="nav-text">Support</span>
              </NavLink>

              <NavLink to="/settings" className={({ isActive }) => `nav-item ${isActive ? "active" : ""}`}>
                <img src={seti} alt="Settings" className="nav-icon" />
